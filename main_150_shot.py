...
def save_model(model):
    ...
    torch.save(checkpoint, 'saved/checkpoint' + "DQN_Model_full" + str(datetime.datetime.now().strftime("%Y-%m-%d %H%M%S")).strip() +'.pt')
...
if __name__ == "__main__": 
    ...
    print(val_env1)
    render = True 
    train(val_env1, dqn_agent, 5, optimizer, target_updates, BATCH_SIZE, GAMMA, render, save, 150, True) # 150-shot learning

    val_env2= gym.make("CartPole-v10")
    print(val_env2)
    render = True   
    train(val_env2, dqn_agent, 5, optimizer, target_updates, BATCH_SIZE, GAMMA, render, save, 150, True) # 150-shot learning
