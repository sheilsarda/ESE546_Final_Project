...
if __name__ == "__main__": 
    ...
    print(val_env1)
    render = True 
    train(val_env1, dqn_agent, 5, optimizer, target_updates, BATCH_SIZE, GAMMA, render, save, 20, True) # 20-shot learning

    val_env2= gym.make("CartPole-v10")
    print(val_env2)
    render = True   
    train(val_env2, dqn_agent, 5, optimizer, target_updates, BATCH_SIZE, GAMMA, render, save, 20, True) # 20-shot learning
